...
public class PopularMortgageScreen extends Screen {
    protected PopularMortgageScreen(@NonNull CarContext carContext) {
        super(carContext);
    }
    ...
    public Template onGetTemplate() {
        ...
        list.addItem(new GridItem.Builder()
                        .setTitle("Compra o Refinanciamiento")
                        .setImage(car_identity)
                        .setOnClickListener(new OnClickListener() {
                            @Override
                            public void onClick() {
                                Intent call = new Intent(Intent.ACTION_DIAL);
                                call.setData(Uri.parse("tel:787-707-7070"));
